...
exports.run = (client, message, args) => {
  ...
  if (message.mentions.users.size < 1) return message.reply('Kimin kafasınası kacağını yazmalısın.').catch(console.error);
    message.channel.send('Kafasına sıkılıyor....')
      .then(nmsg => nmsg.edit('https://media.giphy.com/media/KbwRGCzVsBTkn5Waor/giphy.gif'))
      .then(nmsg => nmsg.edit('https://media.giphy.com/media/KbwRGCzVsBTkn5Waor/giphy.gif'))
      .then(nmsg => nmsg.edit('https://media.giphy.com/media/KbwRGCzVsBTkn5Waor/giphy.gif'))
      .then(nmsg => nmsg.edit('https://media.giphy.com/media/VIQDoKigmaDi4vR4AA/giphy.gif'))
      .then(nmsg => nmsg.edit('https://media.giphy.com/media/VIQDoKigmaDi4vR4AA/giphy.gif'))
      .then(nmsg => nmsg.edit('https://media.giphy.com/media/VIQDoKigmaDi4vR4AA/giphy.gif'))
      .then(nmsg => nmsg.edit('https://media.giphy.com/media/VIQDoKigmaDi4vR4AA/giphy.gif'))
      .then(nmsg => nmsg.edit('https://media.giphy.com/media/VIQDoKigmaDi4vR4AA/giphy.gif'))
