...
exports.run = (client, message, params) => {
  if (!params[0]) {
	...
	message.channel.send({embed: {
            ...
            title: "",
            description: "[Davet Linkim](https://discord.com/oauth2/authorize?client_id=783311891714801724&scope=bot&permissions=2147483647) \n[Destek Sunucusu](https://discord.gg/ftANtTCuQ2)",
            fields: [
            ],
            timestamp: new Date(),
            footer: {
